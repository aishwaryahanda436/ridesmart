...
class OlaParserTest {
    ...
    fun `basic Ola ride parses correctly`() {
        ...
        val result = parser.parse(nodes, "com.olacabs.driver")
        ...
        assertEquals("Package", "com.olacabs.driver", result.packageName)
    }
    ...
    fun `empty input returns null`() {
        assertNull(parser.parse(emptyList(), "com.olacabs.driver"))
    }

    @Test
    fun `idle screen returns empty list from parseAll`() {
        val nodes = listOf("You are offline", "Go online")
        val results = parser.parseAll(nodes, "com.olacabs.driver")
